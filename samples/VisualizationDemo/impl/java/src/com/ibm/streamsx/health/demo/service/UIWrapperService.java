...
public class UIWrapperService {
	...
	public UIWrapperService() throws Exception {
		...
		SPL.addToolkit(topo, new File(System.getProperty("user.dir") + "/data/toolkits/com.ibm.streamsx.health.analyze.vital"));
		SPL.addToolkit(topo, new File(System.getProperty("user.dir") + "/data/toolkits/com.ibm.streamsx.inet"));
	}
