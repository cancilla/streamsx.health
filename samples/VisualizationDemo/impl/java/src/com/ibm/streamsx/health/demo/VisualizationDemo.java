...
public class VisualizationDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		HealthDataBeaconService beaconService = new HealthDataBeaconService("/home/streamsadmin/git/streamsx.health/simulate/com.ibm.streamsx.health.simulate.beacon");
